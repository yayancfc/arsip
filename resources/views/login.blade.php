        ...
        <div class="container-fluid bg">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-10">
                    ...
                    <form method="post"  id="formLogin" class="form-container" action="{{url('login')}}"; >
                       @csrf
                        ...
                        <div class="form-group">
                          <select class="form-control" name="status">
                            <option value="3">Login Sebagai</option>
                        ...
                        <div class="form-group daftar">
                            <span id="textdaftar">Belum Terdaftar?</span>
                            <span><a href="{{url('register')}}" id="register">Daftar</a></span>
                        </div>
                    </form>
